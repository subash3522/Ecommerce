...
//   const ttl = (currentCart) => {
//       return currentCart.reduce((acc, value) => acc + value.price * value.quantity, 0);
//   };
...
//       if (indexChecker !== -1) {
//           newCart = [...cart];
//           newCart[indexChecker].quantity += 1;
//       } else {
//           newCart = [...cart, { ...product, quantity: 1 }];
//       }

//       setCart(newCart);
//       setsubtotal(ttl(newCart));
//   };
...
//                   <div className="filter">
//                       Filter: 
//                       <button onClick={() => filterHandler("Bike")}>Bike</button>
//                       <button onClick={() => filterHandler("Laptop")}>Laptop</button>
//                       <button onClick={() => setproductList(product)}>All</button>
//                   </div>
//                   <div className="allcards">
